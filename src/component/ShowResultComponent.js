    ...
    <Stack sx={{ boxShadow: "rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset", margin: "2rem" }}
      ...
      <Card sx={{ width: "100%", paddingLeft: "1rem", paddingRight: "1rem"}} >
        ...
        <CardContent sx={{ paddingTop: "0", paddingBottom: "0rem" }}>
          ...
          <Typography sx={{ paddingTop: "0.5rem", display: "flex", justifyContent: "center" }} variant="body2" color="text.secondary">
            <Stack>
              {/* <WeatherComponent/> */}
        ...
        <Collapse in={expanded} timeout="auto" unmountOnExit>
          <CardContent sx={{ display: "flex", direction: "row", }}>
            <Stack  sx={{width:"100%"}}>
              ...
              <ResultDetailsComponent /> */}
              {
                item.map(element => {
                  return(
                    element.type === "WALK" ? "":
                    <ResultDetailsComponent Element={element} /> 
                  )
            ...
            {/* <Typography paragraph>Method:</Typography>
              ...
              <Typography>
                Set aside off o the heat to let rest for 10 minutes, and then serve.
              </Typography> */}
          </CardContent>
        </Collapse>
      </Card>
